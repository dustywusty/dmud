...
var ItemTemplates = map[string]*Item{
	...
	"bread": {
		ID:          "bread",
		Name:        "Crusty Bread",
		Description: "A hearty loaf of crusty bread. Restores endurance when eaten.",
		Type:        ItemTypeConsumable,
		Value:       3,
		Stackable:   true,
		Quantity:    1,
	...
	"stamina_draught": {
		...
		Description: "A fizzing green draught that restores a good deal of endurance.",
		Type:        ItemTypeConsumable,
		Value:       15,
		Stackable:   true,
		Quantity:    1,
	...
	"healing_potion": {
		ID:          "healing_potion",
		Name:        "Healing Potion",
		Description: "A swirling red potion that knits wounds and steadies the breath.",
		Type:        ItemTypeConsumable,
		Value:       25,
		Stackable:   true,
		Quantity:    1,
	...
	"cookie": {
		ID:          "cookie",
		Name:        "Cookies",
		Description: "Warm, gooey cookies studded with chocolate chunks. They smell like home and faintly of cinnamon. Someone clearly bakes these with love.",
		Type:        ItemTypeConsumable,
		Value:       2,
		Stackable:   true,
		Quantity:    1,
	...
	"pony": {
		ID:          "pony",
		Name:        "Dapple Pony",
		Description: "A round, sweet-tempered dapple-grey pony with a ribbon-braided mane. One of Wylie's gentler mounts -- steady, sure-footed, and fond of cookies.",
		Type:        ItemTypeMisc,
		Value:       80,
		Stackable:   false,
		Quantity:    1,
	...
	"courser": {
		ID:          "courser",
		Name:        "Midnight Courser",
		Description: "A lean, dark courser draped in purple-and-black barding, silver bells braided into its mane. Wylie's pride and joy: fast as a whispered rumor, with stamina to match.",
		Type:        ItemTypeMisc,
		Value:       200,
		Stackable:   false,
		Quantity:    1,
